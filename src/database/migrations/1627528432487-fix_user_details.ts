...
export class fixUserDetails1627528432487 implements MigrationInterface {
    name = 'fixUserDetails1627528432487'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_9fc134ca20766e165ad650ee740" FOREIGN KEY ("detail_id") REFERENCES "_details"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
